    ...
    stages {
        ...
        stage('Build') {
            steps {
                ...
                sh "docker build . -t 'mypipelineimg'"
        ...
        stage('Test') {
            steps {
                ...
                sh 'docker stop mycontainer || true'               # || means if either one is true then command is success
                sh 'docker rm mycontainer || true'                 # ||: This is the logical OR operator in shell scripting
                ...
                sh 'docker run -d -p80:80 --name mycontainer mypipelineimg'

                // Execute a command inside the running Docker container.
                sh 'docker exec mycontainer ls'
            }
        }
